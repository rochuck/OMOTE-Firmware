...
// This is the main list of guis we want to be shown when swiping. Need not to be all the guis that have been registered, can be
// only a subset. You can swipe through these guis. Will be in the order you place them here in the vector. By default, it is a list
// of the guis that have been registered in main.cpp If a scene defines a scene specific gui list, this will be used instead as long
// as the scene is active and we don't explicitely navigate back to main_gui_list
...
void register_scene_defaultKeys(void) {
  ...
  /*{KEY_CONF,  COMMAND_UNKNOWN  },                                                                          {KEY_INFO,  COMMAND_UNKNOWN  },*/
    ...
    {KEY_RED,   SCENE_APPLETV_FORCE},    {KEY_GREEN, SCENE_KODI_FORCE},    {KEY_YELLO, SCENE_CHROMECAST_FORCE},    {KEY_BLUE,  SCENE_KODI_BT_FORCE},
  };
